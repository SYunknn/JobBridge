...
public class RecruitInfoTagMultiKeysClass implements Serializable{
    private Long recruitInfoId;
    private Integer tagId;

    // constructor
    public RecruitInfoTagMultiKeysClass(){

    }

    public RecruitInfoTagMultiKeysClass(Long recruitInfoId, Integer tagId) {
    ...
    public boolean equals(Object obj){
        ...
        final RecruitInfoTagMultiKeysClass other = (RecruitInfoTagMultiKeysClass)obj;
