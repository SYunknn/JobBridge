 ...
 */
public interface CollectEnterpriseRepository extends JpaRepository<CollectEnterprise, CollectEnterpriseMultiKeysClass> {
    ...
    // void deleteById(Map<String, Object> map);         //通过传入学生ID与公司ID
}
